...
class HexapayDashboard(models.Model):
    """Main model for hexapay_dashboard"""
    _name = 'hexapay.dashboard'
    _description = 'HexapayDashboard'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_dashboard') or 'New'
