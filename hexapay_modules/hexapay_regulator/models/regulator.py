...
class HexapayRegulator(models.Model):
    """Main model for hexapay_regulator"""
    _name = 'hexapay.regulator'
    _description = 'HexapayRegulator'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_regulator') or 'New'
