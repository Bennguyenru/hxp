...
class HexapayLoyalty(models.Model):
    """Main model for hexapay_loyalty"""
    _name = 'hexapay.loyalty'
    _description = 'HexapayLoyalty'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_loyalty') or 'New'
