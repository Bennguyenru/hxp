...
class HexapayAccounting(models.Model):
    """Main model for hexapay_accounting"""
    _name = 'hexapay.accounting'
    _description = 'HexapayAccounting'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_accounting') or 'New'
