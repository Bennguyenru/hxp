...
class HexapayReward(models.Model):
    """Main model for hexapay_reward"""
    _name = 'hexapay.reward'
    _description = 'HexapayReward'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_reward') or 'New'
