...
class HexapayCommission(models.Model):
    """Main model for hexapay_commission"""
    _name = 'hexapay.commission'
    _description = 'HexapayCommission'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_commission') or 'New'
