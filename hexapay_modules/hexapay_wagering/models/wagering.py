...
class HexapayWagering(models.Model):
    """Main model for hexapay_wagering"""
    _name = 'hexapay.wagering'
    _description = 'HexapayWagering'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_wagering') or 'New'
