...
class HexapayOpportunity(models.Model):
    """Main model for hexapay_opportunity"""
    _name = 'hexapay.opportunity'
    _description = 'HexapayOpportunity'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_opportunity') or 'New'
