...
class HexapayAchievement(models.Model):
    """Main model for hexapay_achievement"""
    _name = 'hexapay.achievement'
    _description = 'HexapayAchievement'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_achievement') or 'New'
