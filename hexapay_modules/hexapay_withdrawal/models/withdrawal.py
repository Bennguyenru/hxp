...
class HexapayWithdrawal(models.Model):
    """Main model for hexapay_withdrawal"""
    _name = 'hexapay.withdrawal'
    _description = 'HexapayWithdrawal'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_withdrawal') or 'New'
