...
class HexapaySegmentation(models.Model):
    """Main model for hexapay_segmentation"""
    _name = 'hexapay.segmentation'
    _description = 'HexapaySegmentation'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_segmentation') or 'New'
