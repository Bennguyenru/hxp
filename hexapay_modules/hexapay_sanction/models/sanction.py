...
class HexapaySanction(models.Model):
    """Main model for hexapay_sanction"""
    _name = 'hexapay.sanction'
    _description = 'HexapaySanction'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_sanction') or 'New'
