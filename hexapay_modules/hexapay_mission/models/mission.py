...
class HexapayMission(models.Model):
    """Main model for hexapay_mission"""
    _name = 'hexapay.mission'
    _description = 'HexapayMission'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_mission') or 'New'
