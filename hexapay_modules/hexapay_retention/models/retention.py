...
class HexapayRetention(models.Model):
    """Main model for hexapay_retention"""
    _name = 'hexapay.retention'
    _description = 'HexapayRetention'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_retention') or 'New'
