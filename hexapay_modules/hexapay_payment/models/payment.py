...
class HexapayPayment(models.Model):
    """Main model for hexapay_payment"""
    _name = 'hexapay.payment'
    _description = 'HexapayPayment'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_payment') or 'New'
