...
class HexapayBonusCampaign(models.Model):
    """Main model for hexapay_bonus_campaign"""
    _name = 'hexapay.bonus.campaign'
    _description = 'HexapayBonusCampaign'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_bonus_campaign') or 'New'
