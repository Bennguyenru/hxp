...
class HexapayReferral(models.Model):
    """Main model for hexapay_referral"""
    _name = 'hexapay.referral'
    _description = 'HexapayReferral'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_referral') or 'New'
