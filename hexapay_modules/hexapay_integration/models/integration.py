...
class HexapayIntegration(models.Model):
    """Main model for hexapay_integration"""
    _name = 'hexapay.integration'
    _description = 'HexapayIntegration'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_integration') or 'New'
