...
class HexapayGameAnalytics(models.Model):
    """Main model for hexapay_game_analytics"""
    _name = 'hexapay.game.analytics'
    _description = 'HexapayGameAnalytics'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_game_analytics') or 'New'
