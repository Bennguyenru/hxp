...
class HexapayExchangeRate(models.Model):
    """Main model for hexapay_exchange_rate"""
    _name = 'hexapay.exchange.rate'
    _description = 'HexapayExchangeRate'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_exchange_rate') or 'New'
