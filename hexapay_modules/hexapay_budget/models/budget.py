...
class HexapayBudget(models.Model):
    """Main model for hexapay_budget"""
    _name = 'hexapay.budget'
    _description = 'HexapayBudget'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_budget') or 'New'
