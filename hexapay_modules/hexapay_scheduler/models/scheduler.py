...
class HexapayScheduler(models.Model):
    """Main model for hexapay_scheduler"""
    _name = 'hexapay.scheduler'
    _description = 'HexapayScheduler'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_scheduler') or 'New'
