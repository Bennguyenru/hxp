...
class HexapayPromoCode(models.Model):
    """Main model for hexapay_promo_code"""
    _name = 'hexapay.promo.code'
    _description = 'HexapayPromoCode'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_promo_code') or 'New'
