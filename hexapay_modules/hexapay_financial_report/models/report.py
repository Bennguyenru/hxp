...
class HexapayFinancialReport(models.Model):
    """Main model for hexapay_financial_report"""
    _name = 'hexapay.financial.report'
    _description = 'HexapayFinancialReport'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_financial_report') or 'New'
