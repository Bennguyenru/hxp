...
class HexapaySelfExclusion(models.Model):
    """Main model for hexapay_self_exclusion"""
    _name = 'hexapay.self.exclusion'
    _description = 'HexapaySelfExclusion'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_self_exclusion') or 'New'
