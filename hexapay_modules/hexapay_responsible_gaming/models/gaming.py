...
class HexapayResponsibleGaming(models.Model):
    """Main model for hexapay_responsible_gaming"""
    _name = 'hexapay.responsible.gaming'
    _description = 'HexapayResponsibleGaming'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_responsible_gaming') or 'New'
