...
class HexapayDeposit(models.Model):
    """Main model for hexapay_deposit"""
    _name = 'hexapay.deposit'
    _description = 'HexapayDeposit'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_deposit') or 'New'
