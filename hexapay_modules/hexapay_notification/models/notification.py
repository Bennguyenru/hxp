...
class HexapayNotification(models.Model):
    """Main model for hexapay_notification"""
    _name = 'hexapay.notification'
    _description = 'HexapayNotification'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_notification') or 'New'
