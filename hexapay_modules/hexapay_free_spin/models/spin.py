...
class HexapayFreeSpin(models.Model):
    """Main model for hexapay_free_spin"""
    _name = 'hexapay.free.spin'
    _description = 'HexapayFreeSpin'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_free_spin') or 'New'
