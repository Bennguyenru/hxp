...
class HexapayReconciliation(models.Model):
    """Main model for hexapay_reconciliation"""
    _name = 'hexapay.reconciliation'
    _description = 'HexapayReconciliation'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_reconciliation') or 'New'
