...
class HexapayCashback(models.Model):
    """Main model for hexapay_cashback"""
    _name = 'hexapay.cashback'
    _description = 'HexapayCashback'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_cashback') or 'New'
