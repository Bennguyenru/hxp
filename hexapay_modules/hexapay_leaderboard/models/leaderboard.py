...
class HexapayLeaderboard(models.Model):
    """Main model for hexapay_leaderboard"""
    _name = 'hexapay.leaderboard'
    _description = 'HexapayLeaderboard'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_leaderboard') or 'New'
