...
class HexapayBonusAbuse(models.Model):
    """Main model for hexapay_bonus_abuse"""
    _name = 'hexapay.bonus.abuse'
    _description = 'HexapayBonusAbuse'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_bonus_abuse') or 'New'
