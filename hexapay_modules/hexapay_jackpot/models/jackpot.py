...
class HexapayJackpot(models.Model):
    """Main model for hexapay_jackpot"""
    _name = 'hexapay.jackpot'
    _description = 'HexapayJackpot'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_jackpot') or 'New'
