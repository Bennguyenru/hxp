...
class HexapayCurrency(models.Model):
    """Main model for hexapay_currency"""
    _name = 'hexapay.currency'
    _description = 'HexapayCurrency'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_currency') or 'New'
