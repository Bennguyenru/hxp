...
class HexapayLeadScoring(models.Model):
    """Main model for hexapay_lead_scoring"""
    _name = 'hexapay.lead.scoring'
    _description = 'HexapayLeadScoring'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_lead_scoring') or 'New'
