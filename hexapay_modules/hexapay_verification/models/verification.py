...
class HexapayVerification(models.Model):
    """Main model for hexapay_verification"""
    _name = 'hexapay.verification'
    _description = 'HexapayVerification'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_verification') or 'New'
