...
class HexapayBonusRule(models.Model):
    """Main model for hexapay_bonus_rule"""
    _name = 'hexapay.bonus.rule'
    _description = 'HexapayBonusRule'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_bonus_rule') or 'New'
