...
class HexapayWorkflow(models.Model):
    """Main model for hexapay_workflow"""
    _name = 'hexapay.workflow'
    _description = 'HexapayWorkflow'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_workflow') or 'New'
