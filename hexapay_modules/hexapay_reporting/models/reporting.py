...
class HexapayReporting(models.Model):
    """Main model for hexapay_reporting"""
    _name = 'hexapay.reporting'
    _description = 'HexapayReporting'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_reporting') or 'New'
