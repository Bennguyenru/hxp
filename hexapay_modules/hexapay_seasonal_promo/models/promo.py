...
class HexapaySeasonalPromo(models.Model):
    """Main model for hexapay_seasonal_promo"""
    _name = 'hexapay.seasonal.promo'
    _description = 'HexapaySeasonalPromo'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_seasonal_promo') or 'New'
