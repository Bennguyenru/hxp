...
class HexapayComplianceReport(models.Model):
    """Main model for hexapay_compliance_report"""
    _name = 'hexapay.compliance.report'
    _description = 'HexapayComplianceReport'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_compliance_report') or 'New'
