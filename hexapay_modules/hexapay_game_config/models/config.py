...
class HexapayGameConfig(models.Model):
    """Main model for hexapay_game_config"""
    _name = 'hexapay.game.config'
    _description = 'HexapayGameConfig'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_game_config') or 'New'
