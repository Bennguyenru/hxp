...
class HexapayGameProvider(models.Model):
    """Main model for hexapay_game_provider"""
    _name = 'hexapay.game.provider'
    _description = 'HexapayGameProvider'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_game_provider') or 'New'
