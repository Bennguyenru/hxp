...
class HexapayReactivation(models.Model):
    """Main model for hexapay_reactivation"""
    _name = 'hexapay.reactivation'
    _description = 'HexapayReactivation'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_reactivation') or 'New'
