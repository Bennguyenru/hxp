...
class HexapayTournament(models.Model):
    """Main model for hexapay_tournament"""
    _name = 'hexapay.tournament'
    _description = 'HexapayTournament'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_tournament') or 'New'
