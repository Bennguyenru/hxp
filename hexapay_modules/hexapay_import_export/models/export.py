...
class HexapayImportExport(models.Model):
    """Main model for hexapay_import_export"""
    _name = 'hexapay.import.export'
    _description = 'HexapayImportExport'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_import_export') or 'New'
