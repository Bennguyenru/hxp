...
class HexapayVipManager(models.Model):
    """Main model for hexapay_vip_manager"""
    _name = 'hexapay.vip.manager'
    _description = 'HexapayVipManager'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_vip_manager') or 'New'
