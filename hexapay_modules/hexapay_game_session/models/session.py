...
class HexapayGameSession(models.Model):
    """Main model for hexapay_game_session"""
    _name = 'hexapay.game.session'
    _description = 'HexapayGameSession'
    ...
    def create(self, vals):
        ...
        if not vals.get('code'):
            vals['code'] = self.env['ir.sequence'].next_by_code('hexapay_game_session') or 'New'
